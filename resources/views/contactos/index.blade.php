                ...
                @foreach ($contactos as $contacto)
                    <tr class="whatsapp-light-green">
                        ...
                        <td class="btn_container_2">
                            <a class="btn" href="contactos/{{$contacto->id}}/view"><img src="{{asset('images/ver.png')}}" width="40" alt=""></a>
                            <a class="btn" href="contactos/{{$contacto->id}}/edit"><img src="{{asset('images/lapiz.png')}}" alt="icono lapiz" width="35"></a>
                        </td>
                    </tr>
                @endforeach
            </table>
            <div class="btn_container">
                <a class="btn_crear" href="contactos/create">Nuevo Contacto</a>
            </div>
        </main>
    </section>
</body>
