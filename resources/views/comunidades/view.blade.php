...
<body>
    <section class="container">
        <figure class="container_foto">
            <img src="{{asset('images/comunidad.png')}}" alt="icono" title="Thor Odinson" class="foto">
            <span class="nombre_grupo">{{$comunidad->nombre}}</span>
        </figure>
        <main>
            <table>
                <tr>
        ...
        <div class="btn_container_volver">
            <a href="/comunidades" class="btn_volver">Volver</a>
        </div>
    </section>
</body>
</html>