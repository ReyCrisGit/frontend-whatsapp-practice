                    ...
                    @foreach ($llamadas as $llamada)
                        <tr class="whatsapp-light-green">
                            ...
                            <td class="btn_container_2">
                                <a class="btn" href="llamadas/{{$llamada->id}}/view"><img src="{{asset('images/ver.png')}}" width="40" alt=""></a>
                                {{-- <a class="btn" href="llamadas/{{$llamada->id}}/edit"><img src="{{asset('images/lapiz.png')}}" alt="icono lapiz" width="35"></a> --}}
                            </td>
                        </tr>
                    @endforeach
                </table>
                <div class="btn_container_crear">
                    <a class="btn_crear" href="llamadas/create">Nueva Llamada</a>
                </div>
            </main>
        </main>
    </section>
